                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="firstname">Primeiro nome <span class="text-danger">*</span></label>
                                    <input id="firstname" type="text" placeholder="Primeiro nome" name="firstname" class="form-control input-sm required">
                                </div><!-- end form-group -->
                                <div class="form-group">
                                    <label for="lastname">Último nome <span class="text-danger">*</span></label>
                                    <input id="lastname" type="text" placeholder="Último nome" name="lastname" class="form-control input-sm required">
                                </div><!-- end form-group -->
                                <div class="form-group">
                                    <label for="email">Email <span class="text-danger">*</span></label>
                                    <input id="email" type="email" placeholder="Email" name="email" class="form-control input-sm required email">
                                </div><!-- end form-group -->
                                ...
                                <div class="form-group">
                                    <a href="javascript:void(0);" class="btn btn-default round btn-sm"><i class="fa fa-save mr-5"></i> Save</a>
                                </div><!-- end form-group -->
                            </div><!-- end col -->
                            <div class="col-md-6">
                                <div class="form-group">
