...
<body>
    ...
    <div class="topBar">
        <div class="container">
            <ul class="list-inline pull-left hidden-sm hidden-xs">
                <li><span class="text-primary">Tem alguma dúvida?</span> Contacte 213 456 789</li>
            </ul>
            ...
            <ul class="topBarNav pull-right">
                ...
                <li class="linkdown">
                    ...
                    <ul class="w-110">
                        ...
                        <li class="active"><a href="javascript:void(0);"><img src="img/flags/flag-pt.jpg" class="mr-5" alt="">Português</a></li>
                    </ul>
                </li>
                <li class="linkdown">
                    <a href="javascript:void(0);">
        ...
        <div class="container">
            <div class="row table">
                ...
                <div class="col-sm-6 vertical-align text-center col-lg-offset-3">
                    <input type="text" placeholder="Search" name="email" class="form-control input-md">
                </div><!-- end col -->
    ...
    <!-- start navbar -->
    <navbar class="navbar yamm navbar-default">
        <div class="container">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown active"><a href="#" data-toggle="dropdown" class="dropdown-toggle">Home<i class="fa fa-angle-down ml-5"></i></a>
                        <ul role="menu" class="dropdown-menu">
                            ...
                            <li><a href="home-v4.html">Home - Version 4 <span class="label primary-background">New</span></a></li>
                            <li class="active"><a href="home-v5.html">Home - Version 5 <span class="label primary-background">New</span></a></li>
                        </ul><!-- end ul dropdown-menu -->
                    </li><!-- end li dropdown -->    
                    <!-- Features -->
                    <li class="dropdown"><a href="#" data-toggle="dropdown" class="dropdown-toggle">Features<i class="fa fa-angle-down ml-5"></i></a>
                                ...
                                <div class="yamm-content">
                                    <div class="row">
                                        ...
                                        <ul class="col-sm-3">
                                            ...
                                            <li><a href="order-confirmation.html">Order Confirmation <span class="label primary-background">New</span></a></li>
                                        ...
                                        <ul class="col-sm-3">
                                            ...
                                            <li><a href="blank-page.html">Blank Page <span class="label primary-background">New</span></a></li>
