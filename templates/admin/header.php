                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-home"></i> Páginas <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="?page=clients">Clientes</a></li>
                      <li><a href="?page=workers">Funcionários</a></li>
                      <li><a href="?page=admins">Administradores</a></li>
                      <li><a href="?page=comments">Comentários</a></li>
                      <li><a href="?page=logs_clients">Logs Clientes</a></li>
                    </ul>
                  </li>
                  <!--
