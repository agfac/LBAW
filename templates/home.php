					...
					<div class="item">
						<figure>
							<a href="javascript:void(0);">
								<img src="img/slider/banner_books.jpg" alt=""/>
							</a>
						</figure>
					</div><!-- end item -->
					<div class="item">
						<figure>
							<a href="javascript:void(0);">
								<img src="img/slider/banner_descontos.jpg" alt=""/>
							</a>
						</figure>
					</div><!-- end item -->
					<div class="item">
		...
		<div class="row">
			<div class="col-sm-6">
				<div class="box-banner-img">
					<figure>
						<a href="javascript:void(0);">
							<img src="img/banners/banner_plano_nacional_leitura.jpg" alt=""/>
						</a>
					</figure>
			...
			<div class="col-sm-6">
				<div class="box-banner-img">
					<figure>
						<a href="javascript:void(0);">
							<img src="img/banners/banner_edu_literaria.jpg" alt=""/>
						</a>
					</figure>
				</div><!-- end box-banner-img -->
			</div><!-- end col -->
