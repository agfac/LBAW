                    ...
                    <div class="col-sm-4 col-md-3">
                        <div class="navbar-vertical">
                            <ul class="nav nav-stacked">
                                ...
                                <li><a href="javascript:void(0);">Apoio Escolar</a></li>
                            ...
                            <div class="item">
                                <figure>
                                    <a href="javascript:void(0);">
                                        <img src="img/slider/books_2.jpg" alt=""/>
                                    </a>
                                </figure>
                            </div><!-- end item -->
                            <div class="item">
                                <figure>
                                    <a href="javascript:void(0);">
                                        <img src="img/slider/books.jpg" alt=""/>
                                    </a>
                                </figure>
                            </div><!-- end item -->
                            <div class="item">
                                <figure>
                                    <a href="javascript:void(0);">
                                        <img src="img/slider/books_4.jpg" alt=""/>
                                    </a>
                                </figure>
                            </div><!-- end item -->
                            <div class="item">
                                <figure>
                                    <a href="javascript:void(0);">
                                        <img src="img/slider/books_3.jpg" alt=""/>
                                    </a>
                                </figure>
                            </div><!-- end item -->
        ...
        <section class="section white-background">
            <div class="container">
                    ...
                    <div class="col-sm-6 col-md-3">
                        <div class="thumbnail store style1">
                            <div class="header">
                                ...
                                <figure class="layer">
                                    <a href="javascript:void(0);">
                                        <img class="front" src="img/books/books_5.jpg" alt="">
                                        <img class="back" src="img/books/books_6.jpg" alt="">
                                    </a>
                                </figure>
                                <div class="icons">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="title-wrap">
                            <h2 class="title"><span class="text-primary">Publicações</span> Populares</h2>
                        </div>
                    </div><!-- end col -->
                </div><!-- end row -->
                            ...
                            <div class="product">
                                <div class="row">
                                    <div class="col-sm-4 vertical-align">
                                        <figure>
                                            <a href="shop-single-product-v1.html"> 
                                                <img alt="img" src="img/products/men_06.jpg">
                                            </a>
                                        </figure>
                                    </div><!-- end col -->
                                    <div class="col-sm-8 vertical-align">
        ...
        <section class="section white-backgorund">
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="title-wrap">
                            <h2 class="title"><span class="text-primary">Novidades</span></h2>
                        </div>
                    </div><!-- end col -->
                </div><!-- end row -->
                    ...
                    <div class="col-sm-4">
                        <div class="widget">
                            ...
                            <ul class="items">
                                <li> 
                                    <a href="shop-single-product-v1.html" class="product-image">
                                        <img src="img/products/men_02.jpg" alt="Sample Product ">
                                    </a>
                                    <div class="product-details">
                                        <h6 class="regular"> 
                                            <a href="shop-single-product-v1.html">Printed Summer Dress</a> 
                                ...
                                <li> 
                                    <a href="shop-single-product-v1.html" class="product-image">
                                        <img src="img/products/women_01.jpg" alt="Sample Product ">
                                    </a>
                                    <div class="product-details">
                                        <h6 class="regular">
                                            <a href="shop-single-product-v1.html">Printed Summer Dress</a> 
                                ...
                                <li> 
                                    <a href="shop-single-product-v1.html" class="product-image">
                                        <img src="img/products/women_04.jpg" alt="Sample Product ">
                                    </a>
                                    <div class="product-details">
                                        <h6 class="regular">
                                            <a href="shop-single-product-v1.html">Printed Summer Dress</a> 
                    ...
                    <div class="col-sm-4">
                        <div class="widget">
                            ...
                            <ul class="items">
                                ...
                                <li> 
                                    <a href="shop-single-product-v1.html" class="product-image">
                                        <img src="img/products/women_03.jpg" alt="Sample Product ">
                                    </a>
                                    <div class="product-details">
                                        <h6 class="regular">
                                            <a href="shop-single-product-v1.html">Printed Summer Dress</a> 
                                ...
                                <li> 
                                    <a href="shop-single-product-v1.html" class="product-image">
                                        <img src="img/products/bags_02.jpg" alt="Sample Product ">
                                    </a>
                                    <div class="product-details">
                                        <h6 class="regular">
                                            <a href="shop-single-product-v1.html">Printed Summer Dress</a> 
                                ...
                                <li> 
                                    <a href="shop-single-product-v1.html" class="product-image">
                                        <img src="img/products/bags_04.jpg" alt="Sample Product ">
                                    </a>
                                    <div class="product-details">
                                        <h6 class="regular">
                                            <a href="shop-single-product-v1.html">Printed Summer Dress</a> 
