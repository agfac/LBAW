$(document).ready(function() {
    $('#search').on('click', function(){
        ...
        $.getJSON("../../actions/owner/orders_search.php", {nome_cliente: nome_cliente, email_cliente: email_cliente, id_encomenda: id_encomenda, estadoencomenda: estadoencomenda}, function(data){
            console.log(data);
