                ...
                <div class="row">
                    ...
                    <div class="col-sm-3">
                        ...
                        <div class="widget">
                            ...
                            <p>Existem 2 itens no carrinho</p>
                            <hr class="spacer-10">
                            <ul class="items">
                                <li> 
                            ...
                            <hr class="spacer-10">
                            <strong class="text-dark">Subtotal:<span class="pull-right text-primary">€19.99</span></strong>
                            <hr class="spacer-10">
                        ...
                        <div class="row column-3">
                            <div class="col-sm-6 col-md-4">
                                <div class="thumbnail store style1">
                                    <div class="header">
                                        <div class="badges">
                                            <span class="product-badge top left primary-background text-white semi-circle">Novidade</span>
